    ...
    <div id="product-container">
        <section class="container-fluid no-padding">
            <div class="main-banner banner-potsautres">
                <div class="mb-text">
                    <h3 class="mbt-h3"> Autres Pots</h3>
                    <p class="mbt-p">
                         Pot 1L et Seau 21L
                    </p>
                </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                        <div class="cc-box-content">
                            <div class="ccbc-text">
                                ...
                                <h3 class="ccbct-h3 ccbct-h3-small">Pot 1L </h3>
                                ...
                                <a href="{{ site.url }}/assets/documents/pot1l/fr/potetseaucarty_plaquette.pdf" target="_blank" class="ccbct-button-action"> Télécharger la plaquette </a>
                                <a target="_blank" href="{{ site.url }}/assets/documents/pot1l/fr/potseau_fichetechnique.pdf" class="ccbct-link-action"> Fiche technique </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                        <div class="cc-box-content">
                            <div class="ccbc-text">
                                ...
                                <h3 class="ccbct-h3 ccbct-h3-small"> Seau avec Fermeture de Sécurité </h3>
                                ...
                                <a href="{{ site.url }}/assets/documents/seau21l/fr/seau21l_plaquette.pdf" target="_blank" class="ccbct-button-action" > Télécharger la plaquette </a>
                                <a target="_blank" href="{{ site.url }}/assets/documents/seau21l/fr/seau21l_fichetechnique.pdf"  class="ccbct-link-action"> Fiche technique </a>
                            </div>
                        </div>
                    </div>
        ...
        <section id="product-color-simulator" class="pcs-big-padding-bottom">
            <div class="wrapper">
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-xs-12 col-sm-12">
                        {% include potscarty-autres-aside.html %}
                    </div>
                    <div class="col-lg-9 col-md-9 col-xs-12 col-sm-12">
                        <div id="products-container">
                            <div id="first-radio-container-boxes">
                                    {% include potscarty-autres-1.html %} 
                            </div>
                            <div id="second-radio-container-boxes" style="display:none;">
                                    {% include potscarty-autres-21.html %} 
                            </div>
