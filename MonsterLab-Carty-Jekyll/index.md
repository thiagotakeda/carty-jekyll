    ...
    <div id="home">
        <section class="container-fluid no-padding">
            <div class="main-banner">
                <div class="mb-text">
                    <img src="/images/index/icon-diamond.svg">
                    <p class="mbt-p">
                ...
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    <div class="hcta-first">
                        <div class="hctaf-box">
                            ...
                            <img class="hctafb-cucumber" src="/images/index/cucumber.png">            <img class="hctafb-strawberry" src="/images/index/strawberry.png">      
                        </div>
                    </div>
                </div> 
        ...
        <section id="home-clients">
            <div class="wrapper">
                <div class="row">
                    ...
                    <img class="hclb-img" src="/images/index/icon_grossites.svg">
                    <p class="hclb-text">Grossistes pour les métiers de bouche </p>
                    </div>
                    <div class="col-lg-4 col-md-4 col-xs-12 col-sm-4 hcl-box">
                    <img class="hclb-img" src="/images/index/icon_industriel.svg">
                    <p class="hclb-text">Industriels du domaine agro-alimentaire </p>   
                    </div>
                    <div class="col-lg-4 col-md-4 col-xs-12 col-sm-4 hcl-box">
                    <img class="hclb-img" src="/images/index/icon-gms.svg">  
